...
def analyze(method, truths, predictions):
    ...
    Args:
        ...
        truths: array_like
            1xn array of correct classifications
        predictions: array_like
            1xn array of predicted classifications
    ...
    truths = np.asanyarray(truths).flatten()
    predictions = np.asanyarray(predictions).flatten()
    ...
    if method == 'abs':
        ...
        # a is the sum of the squared errors
